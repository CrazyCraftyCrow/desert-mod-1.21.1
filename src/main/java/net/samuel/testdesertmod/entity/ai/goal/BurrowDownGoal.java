...
public class BurrowDownGoal extends Goal {
    private final DesertRainFrogEntity mauler;
    ...
    public BurrowDownGoal(DesertRainFrogEntity mauler) {
        this.mauler = mauler;
    }
    ...
    public void stop() {
        ...
        this.mauler.setTicksUntilNextBurrowingDown(
                this.mauler.getRandom().nextBetween(
                        DesertRainFrogEntity.MIN_TICKS_UNTIL_NEXT_BURROWING,
                        DesertRainFrogEntity.MAX_TICKS_UNTIL_NEXT_BURROWING
                )
        );
    }
